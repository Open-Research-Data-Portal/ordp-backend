...
urlpatterns = [
    ...
    path("users/inactive/", dashboard_views.inactive_users, name="admin-inactive-users"),
    ...
    path("admin-succession/", dashboard_views.admin_succession, name="admin-succession"),
    path("draft-expiration/", dashboard_views.draft_expiration, name="admin-draft-expiration"),
